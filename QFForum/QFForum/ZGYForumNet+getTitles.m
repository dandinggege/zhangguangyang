...
#import "ZGYForumNet+getTitles.h"

@implementation ZGYForumNet (getTitles)
...
+(void)getTitlesWithPageNum:(NSInteger)pageNum
    ...
    NSString * md5Str=[ZGYFunction getMD5StrFromString:[NSString stringWithFormat:@"getTitlesQF%@",timeStamp]];
    //拼接URL
    NSMutableString * URLStr=[[NSMutableString alloc]init];
    [URLStr appendFormat:@"%@%@?",ZGY_DOMAIN_NAME,ZGY_TITLE_GET_TS];
